#!/usr/bn/python
# Author: Govinda
# Details: This is going create the  Neural Network  used
# to train the Agnet.  The model used is DDPG
...
# This module will add basic policy and vlaue function for agent
######################################################################
import numpy as np
...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=128, fc2_units=64, fc3_units=16):
        ...
        ======
            ...
            fc1_units (int): Number of nodes in first hidden laayer
